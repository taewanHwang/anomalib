#!/bin/bash
# nohup ./examples/hdmap/multi_domain/patchcore-run.sh > /dev/null 2>&1 &
# pkill -f "patchcore-run.sh"
# pkill -f "examples/hdmap/multi_domain/patchcore-training.py"
...
SCRIPT_PATH="examples/hdmap/multi_domain/patchcore-training.py"
